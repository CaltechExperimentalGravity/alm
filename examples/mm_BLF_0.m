...
% create the BeamPath object
goo = beamPath;
goo.addComponent(component.lens(1, 0.5, 'lens1'));
goo.addComponent(component.lens(1, 1, 'lens2'));

w_FI = 200e-6;
z_FI = 0.1;

goo.seedWaist(w_FI, z_FI);
...
% distance from Faraday to cavity waist = 60" + 1.3m
% cavity waist size = 650 um

z_cav = 60 * 0.0254 + 1.3;
w_cav = 650e-6;

goo.targetWaist(w_cav, z_cav); %want it 20in away
