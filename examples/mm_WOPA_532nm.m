%First, I need to profile the beam. Might as well try to set up what lenses
%are available and make sure the code works for 532nm.
%TO DO THIS, MUST REWRITE 1064 to 532 in BEAMPATH.M; so I will not do this until done
%With 1064 for both WOPA and SFG.
% goo = beamPath;
